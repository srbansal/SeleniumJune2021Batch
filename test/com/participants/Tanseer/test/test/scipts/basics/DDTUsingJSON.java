...
import static Scripts.basics.DDTUsingJSON.driver;
...
public class DDTUsingJSON {
    ...
    public static void main(String[] args) throws InterruptedException, IOException, ParseException, org.json.simple.parser.ParseException {
        ...
        System.setProperty("webdriver.chrome.driver", "F:\\persistentTrainings\\5Java\\SeleniumWebDrier\\test\\resources\\chromedriver.exe");
...
try  {
FileReader reader = new FileReader("F:\\persistentTrainings\\5Java\\SeleniumWebDrier\\test\\tests\\testNG\\Testdata.json");
//Read JSON file
            ...
            JSONObject users= usersList.getJSONObject(i);
