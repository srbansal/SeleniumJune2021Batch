...
public class Node2IE {
    ...
    public void firefoxtest() throws IOException, InterruptedException{
		...
		DesiredCapabilities  dr2=DesiredCapabilities.internetExplorer();
         //set browser name
		 dr2.setBrowserName("internet explorer");
         //set platform as windows
         dr2.setPlatform(Platform.WINDOWS);
         
     //using the RemoteWebDriver object
     RemoteWebDriver driver=new RemoteWebDriver(new  URL("http://192.168.43.77:45949/wd/hub"), dr2);
