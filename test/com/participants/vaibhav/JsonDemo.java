...
public class JsonDemo {
  ...
  public void beforeTest() {
	  ...
	  System.setProperty("webdriver.gecko.driver", "test/resorces/geckodriver.exe");
  ...
  public String login(String username, String password) throws InterruptedException {
	  ...
	  try  {
	  FileReader reader = new FileReader("test/resorces/Testdata.json");
	  //Read JSON file
	              ...
	              //Write JSON file
	                  try (FileWriter file = new FileWriter("test/resorces/Testdata.json")) {
